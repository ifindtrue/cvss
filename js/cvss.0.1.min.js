...
$element&&$element.height||0,g.height);a.x=m(u(this.$canvas.width,a.x,g.x),$element&&$element.x,g.x);a.y=m(u(this.$canvas.height,a.y,g.y),$element&&$element.y,g.y);f=a.width;a.minWidth&&(a.minWidth=m(u(this.$canvas.width,a.minWidth,0),$element&&$element.minWidth||0,0),f=a.minWidth<a.width?a.width:a.minWidth);a.maxWidth&&(a.maxWidth=m(u(this.$canvas.width,a.maxWidth,f),$element&&$element.maxWidth||0,f),f=a.maxWidth<f?a.maxWidth:f);p=a.height;a.minHeight&&(a.minHeight=m(u(this.$canvas.height,a.minHeight,
0),$element&&$element.minHeight||0,0),p=a.minHeight<a.height?a.height:a.minHeight);a.maxHeight&&(a.maxHeight=m(u(this.$canvas.height,a.maxHeight,p),$element&&$element.maxHeight||0,p),p=a.maxHeight<p?a.maxHeight:p);h=a.x;k=a.y;q="string"==typeof a.origin?a.origin.split(" "):g.origin;h-=u(a.width,q[0],g.origin[0]);k-=u(a.height,q[1],g.origin[1]);this.$context.fillStyle=a.background?a.background:g.background;if(!$element&&"string"==typeof a.border||"string"==typeof a.border&&$element&&$element.border!=
a.border)q=a.border.split(" "),e=m(q[0],0,g.borderWidth),this.$context.lineWidth=e,c=q[2]||g.borderColor,this.$context.strokeStyle=c;e||(e=m(a.borderWidth,$element&&$element.borderWidth||0,g.borderWidth),this.$context.lineWidth=e);c||(c=a.borderColor||g.borderColor,this.$context.strokeStyle=c);a.borderWidth=e;a.borderColor=c;a.border=e+" solid "+c;if(a.backgroundImage){"string"==typeof a.backgroundImage&&(r=a.backgroundImage.split(" "),A=r[0]||g.backgroundImage.src,z=-1!=H.indexOf(r[1])?r[1]:g.backgroundImage.pattern,
...
a.translateY&&(a.translateY=m(u(a.height,a.translateY,g.translate.y),$element&&$element.translateY,g.translate.y));"number"==typeof a.scaleX&&(a.scaleX=m(u(a.width,a.scaleX,g.scale.x),$element&&$element.scaleX,g.scale.x));"number"==typeof a.scaleY&&(a.scaleY=m(u(a.height,a.scaleY.initElement.scale.y),$element&&$element.scaleY,g.scale.y));e="number"==typeof a.translateX?a.translateX:g.translate.x;c="number"==typeof a.translateY?a.translateY:g.translate.y;if(a.rotate){a.rotate=
m(a.rotate,$element&&$element.rotate,g.rotate,!1);a.rotateOriginX=m(u(a.width,a.rotateOriginX,g.rotateOrigin.x),$element&&$element.rotateOriginX,g.rotateOrigin.x);a.rotateOriginY=m(u(a.height,a.rotateOriginY,g.rotateOrigin.y),$element&&$element.rotateOriginY,g.rotateOrigin.y);var q=Math.cos(a.rotate*Math.PI/180),B=Math.sin(a.rotate*Math.PI/180);event.line=[[-a.rotateOriginX*q+a.rotateOriginY*B+h+a.rotateOriginX+e,-a.rotateOriginX*B-a.rotateOriginY*q+k+a.rotateOriginY+c],[(f-a.rotateOriginX)*q+a.rotateOriginY*
B+h+a.rotateOriginX+e,(f-a.rotateOriginX)*B-a.rotateOriginY*q+k+c+a.rotateOriginY],[(f-a.rotateOriginX)*q-(p-a.rotateOriginY)*B+h+a.rotateOriginX+e,(f-a.rotateOriginX)*B+(p-a.rotateOriginY)*q+k+a.rotateOriginY+c],[-a.rotateOriginX*q-(p-a.rotateOriginY)*B+h+a.rotateOriginX+e,-a.rotateOriginX*B+(p-a.rotateOriginY)*q+k+a.rotateOriginY+c]]}else event.line=[[h+e,k+c],[h+f+e,k+c],[h+f+e,k+p+c],[h+e,k+p+c]];t=event.line;delete a.$temp}else h=a.$x,k=a.$y,f=a.width,p=a.height,this.$context.fillStyle=a.background?
a.background:g.background,this.$context.lineWidth=a.borderWidth,this.$context.strokeStyle=a.borderColor,a.backgroundImage&&(v=a.backgroundImageX,r=a.backgroundImageY,z=a.backgroundImagePattern,A=a.backgroundImageSrc),e="number"==typeof a.translateX?a.translateX:g.translate.x,c="number"==typeof a.translateY?a.translateY:g.translate.y;if(a.backgroundImage){var L=this.$imageSrc.indexOf(A);if(-1==L){var q=new Image,F=this;q.onload=function(){F.$imageData.push(this);F.$imageSrc.push(this.src);F.$imageDataMatch[w[l]]=
F.$imageData.length-1;F.createElement(F.$element)};q.src=A;a.$backgroundImage={width:NaN,height:NaN}}else{var n=this.$imageData[L],x=f<n.width?f:n.width,y=p<n.height?p:n.height;a.$backgroundImage={width:n.width,height:n.height}}}if(!1===a.show||"false"==a.show){a.show=!1;this.$element[w[l]]=a;this.$context.restore();continue}if(!0===a.onlyBaseElement||"true"==a.onlyBaseElement){a.onlyBaseElement=!0;this.$element[w[l]]=a;this.$context.restore();continue}this.$context.translate(e,c);a.rotate&&(C=h,
K=k,this.$context.translate(h+a.rotateOriginX,k+a.rotateOriginY),h=-a.rotateOriginX,k=-a.rotateOriginY,this.$context.rotate(a.rotate*Math.PI/180));0<a.borderWidth&&this.$context.strokeRect(h-a.borderWidth/2,k-a.borderWidth/2,f+a.borderWidth,p+a.borderWidth);this.$context.fillRect(h,k,f,p);if(-1!==L)if("no-repeat"==z)z=A=0,e=x,c=y,q=h+v,B=k+r,0>v?(A=-v,e=x,q=h):v+n.width>f&&(A=0,e=f-v),0>r?(z=-r,c=y,B=k):r+n.height>p&&(z=0,c=p-r),this.$context.drawImage(n,A,z,e,c,q,B,e,c);else if("repeat"==z){var v=
Math.ceil(f/n.width),r=Math.ceil(p/n.height),G=v*r,D=f%n.width,E=p%n.height;for(f=1;f<=G;f++)f==G?this.$context.drawImage(n,0,0,D,E,h+(v-1)*x,k+(r-1)*y,D,E):0==f%v?this.$context.drawImage(n,0,0,D,y,h+(v-1)*x,k+parseInt((f-1)/v)*y,D,y):f>(r-1)*v?this.$context.drawImage(n,0,0,x,E,h+parseInt((f-1)%v)*x,k+(r-1)*y,x,E):this.$context.drawImage(n,0,0,x,y,h+(f%v-1)*x,k+parseInt((f-1)/v)*y,x,y)}else{var I,J;switch(z){case "repeat-x":G=parseInt(f/n.width);D=f%n.width;E=p<n.height?p:n.height;I=n.width;J=0;x=
f<n.width?f:n.width;break;case "repeat-y":G=parseInt(p/n.height),E=p%n.height,D=f<n.width?f:n.width,I=0,J=n.height,y=p<n.height?p:n.height}for(f=0;f<=G;f++)f==G?this.$context.drawImage(n,0,0,D,E,h+f*I,k+f*J,D,E):this.$context.drawImage(n,0,0,x,y,h+f*I,k+f*J,x,y)}h=C?C:h;k=K?K:k;a.$x=h;a.$y=k;break;case "path":if(a.$temp||!$element){if(!$element&&"string"==typeof a.border||"string"==typeof a.border&&$element&&$element.border!=a.border)q=a.border.split(" "),e=m(q[0],0,g.borderWidth),this.$context.lineWidth=
...
typeof a.r?a.r.split(" "):0,a.r1=isR1?a.r1:m(C[0],$element&&$element.r1||0,g.circle.r),a.r2=isR2?a.r2:m(C[1],$element&&$element.r2||0,a.r1);isR1&&(a.r1=m(a.r1,$element&&$element.r1||0,0));isR2&&(a.r2=m(a.r2,$element&&$element.r2||0,0));a.r1||(a.r1=g.circle.r);a.r2||(a.r2=g.circle.r);a.r=a.r1+" "+a.r2;if(!$element&&"string"==typeof a.border||"string"==typeof a.border&&$element&&$element.border!=a.border)q=a.border.split(" "),e=m(q[0],0,g.borderWidth),this.$context.lineWidth=e,c=q[2]||g.borderColor,
this.$context.strokeStyle=c;e||(e=m(a.borderWidth,$element&&$element.borderWidth||0,g.borderWidth),this.$context.lineWidth=e);c||(c=a.borderColor||g.borderColor,this.$context.strokeStyle=c);a.borderWidth=e;a.borderColor=c;a.border=e+" solid "+c;a.start||(a.start=g.circle.start);a.end||(a.end=g.circle.end);a.clock||(a.clock=g.circle.clock);"object"==typeof a.origin&&(h-=u(2*a.r1,a.origin[0],g.origin[0]),k-=u(2*a.r1,a.origin[1],g.origin[1]));this.$context.beginPath();a.r2&&a.r1!=a.r2?this.$context.ellipse(h,
k,a.r1,a.r2,0,a.start,a.end,!1):this.$context.arc(h,k,a.r1,a.start,a.end,a.clock);a.background&&(this.$context.fillStyle=a.background,this.$context.fill());0<a.borderWidth&&this.$context.stroke();"object"!=typeof event.c&&(event.c={});a.r1>a.r2?(event.c.x=Math.sqrt((a.r1-a.r2)*(a.r1+a.r2))+h,event.c.y=k,event.c.mirrorx=-event.c.x+2*h,event.c.mirrory=k,event.a=a.r1,event.mirror=!0):a.r1==a.r2?(event.c.x=h,event.c.y=k,event.c.mirrorx=h,event.c.mirrory=k,event.a=a.r1,event.mirror=!0):(event.c.y=Math.sqrt((a.r2-
a.r1)*(a.r1+a.r2))+k,event.c.x=h,event.c.mirrorx=h,event.c.mirrory=-event.c.y+2*k,event.a=a.r2,event.mirror=!1);a.$x=h;a.$y=k;delete a.$temp}else this.$context.beginPath(),a.r2&&a.r1!=a.r2?this.$context.ellipse(a.$x,a.$y,a.r1,a.r2,0,a.start,a.end,!1):this.$context.arc(a.$x,a.$y,a.r1,a.start,a.end,a.clock),a.background&&(this.$context.fillStyle=a.background,this.$context.fill()),0<a.borderWidth&&this.$context.stroke();break;case "text":h="string"==typeof a.content||"number"==typeof a.content?a.content:
g.content,this.$context.font=(a.fontSize||g.fontSize)+" "+(a.fontFamily||g.fontFamily),a.x=m(a.x,$element&&$element.x,g.x),a.y=m(a.y,$element&&$element.y,g.y),this.$context.fillText(h,a.x,a.y)}this.$element[w[l]]=a;this.$context.restore()}};Canvas.prototype.element=function(b){if(!this.$canvas)return console.error("CvSS ERROR : not found element"),0;if(b==this)return this.$windowEvent;this.$cvss_target="string"==typeof b||"number"==typeof b?String(b):void 0;return this};Canvas.prototype.cvss=function(b,
d){if(!this.$element[this.$cvss_target])return console.error("CvSS ERROR : not found element"),0;var e={};if(!d&&""!=d||"string"!=typeof b){if("[object Array]"===Object.prototype.toString.call(b)){for(var c={},e=0;e<b.length;e++)c[b[e]]=this.$element[this.$cvss_target][b[e]];return c}if("object"==typeof b)e[this.$cvss_target]=Canvas.prototype.setBaseObj(this.$element[this.$cvss_target],b,!0),this.createElement(e);else if(this.$element[this.$cvss_target]&&this.$element[this.$cvss_target][b])return"object"==
...
Math.PI,clock:!0},backgroundImage:{src:void 0,pattern:"no-repeat"},border:[1],cursor:"default",fontSize:"12px",fontFamily:"Arial",borderColor:"black",borderWidth:0,content:"",figure:!0,rotate:0,rotateOrigin:{x:"50%",y:"50%"}};Canvas.prototype.$Element_Type=["block","path","circle","text"];Canvas.prototype.$Element_Event="mouseup mousedown click mousein mouseout dblclick dragstart drag drop".split(" ");Canvas.prototype.$lineJoin=["miter","round","bevel"];Canvas.prototype.$backgroundRepeatType=["no-repeat",
