...
[b,this.$dragElement]));var e=!1,c;for(d=this.$elementKey.length-1;0<=d;d--)if(c=this.$element[this.$elementKey[d]],!1!==c.show&&!0!==c.onlyBaseElement){var k=this.$event[this.$elementKey[d]];switch(c.type){case "block":e=Canvas.prototype.polygonInsideCheck({x:b.x,y:b.y},k.line);break;case "path":e=Canvas.prototype.polygonInsideCheck({x:b.x,y:b.y},k.line);break;case "circle":k=this.$event[this.$elementKey[d]].c,Math.sqrt(Math.pow(b.x-k.x,2)+Math.pow(b.y-k.y,2))+Math.sqrt(Math.pow(b.x-k.mirrorx,2)+
Math.pow(b.y-k.mirrory,2))<2*this.$event[this.$elementKey[d]].a&&(e=!0)}if(e){d=this.$elementKey[d];this.$canvas.style.cursor=c.cursor||this.$initElement.cursor;if(this.$preOver==d)return 0;this.$preOver&&this.$preOver!=d&&this.$eventFunc[this.$preOver]&&"function"==typeof this.$eventFunc[this.$preOver].mouseout?this.$eventFunc[this.$preOver].mouseout.apply(this,[b,this.$preOver]):this.$preOver&&this.$preOver!=d&&this.$element[this.$preOver].baseEventElement&&this.$eventFunc[this.$element[this.$preOver].baseEventElement]&&
...
this.$element[this.$dragElement].baseEventElement&&this.$eventFunc[this.$element[this.$dragElement].baseEventElement]&&"function"==typeof this.$eventFunc[this.$element[this.$dragElement].baseEventElement].drop&&this.$eventFunc[this.$element[this.$dragElement].baseEventElement].drop.apply(this,[NaN,this.$dragElement]));var k=!1,f;for(c=this.$elementKey.length-1;0<=c;c--)if(f=this.$element[this.$elementKey[c]],!1!==f.show&&!0!==f.onlyBaseElement){var a=this.$event[this.$elementKey[c]];switch(f.type){case "block":k=
Canvas.prototype.polygonInsideCheck({x:e.x,y:e.y},a.line);break;case "path":k=Canvas.prototype.polygonInsideCheck({x:e.x,y:e.y},a.line);break;case "circle":a=this.$event[this.$elementKey[c]].c,Math.sqrt(Math.pow(e.x-a.x,2)+Math.pow(e.y-a.y,2))+Math.sqrt(Math.pow(e.x-a.mirrorx,2)+Math.pow(e.y-a.mirrory,2))<2*this.$event[this.$elementKey[c]].a&&(k=!0)}if(k){"mousedown"==d&&this.$preEvent!=this.$elementKey[c]&&(clearTimeout(this.$dblclickTimerFunc),this.$dblclickTimer=!1);if("mouseup"==d&&this.$preEvent==
...
0),$element&&$element.minHeight||0,0),q=a.minHeight<a.height?a.height:a.minHeight);a.maxHeight&&(a.maxHeight=m(u(this.$canvas.height,a.maxHeight,q),$element&&$element.maxHeight||0,q),q=a.maxHeight<q?a.maxHeight:q);h=a.x;l=a.y;p="string"==typeof a.origin?a.origin.split(" "):g.origin;h-=u(a.width,p[0],g.origin[0]);l-=u(a.height,p[1],g.origin[1]);this.$context.fillStyle=a.background?a.background:g.background;if(!$element&&"string"==typeof a.border||"string"==typeof a.border&&$element&&$element.border!=
...
$element.rotate,g.rotate,!1);a.rotateOriginX=m(u(a.width,a.rotateOriginX,g.rotateOrigin.x),$element&&$element.rotateOriginX,g.rotateOrigin.x);a.rotateOriginY=m(u(a.height,a.rotateOriginY,g.rotateOrigin.y),$element&&$element.rotateOriginY,g.rotateOrigin.y);var p=Math.cos(a.rotate*Math.PI/180),B=Math.sin(a.rotate*Math.PI/180);event.line=[[-a.rotateOriginX*p+a.rotateOriginY*B+h+a.rotateOriginX+e,-a.rotateOriginX*B-a.rotateOriginY*p+l+a.rotateOriginY+c],[(f-a.rotateOriginX)*p+a.rotateOriginY*B+h+a.rotateOriginX+
e,(f-a.rotateOriginX)*B-a.rotateOriginY*p+l+c+a.rotateOriginY],[(f-a.rotateOriginX)*p-(q-a.rotateOriginY)*B+h+a.rotateOriginX+e,(f-a.rotateOriginX)*B+(q-a.rotateOriginY)*p+l+a.rotateOriginY+c],[-a.rotateOriginX*p-(q-a.rotateOriginY)*B+h+a.rotateOriginX+e,-a.rotateOriginX*B+(q-a.rotateOriginY)*p+l+a.rotateOriginY+c]]}else event.line=[[h+e,l+c],[h+f+e,l+c],[h+f+e,l+q+c],[h+e,l+q+c]];t=event.line;delete a.$temp}else h=a.$x,l=a.$y,f=a.width,q=a.height,this.$context.fillStyle=a.background?a.background:
g.background,this.$context.lineWidth=a.borderWidth,this.$context.strokeStyle=a.borderColor,a.backgroundImage&&(v=a.backgroundImageX,r=a.backgroundImageY,z=a.backgroundImagePattern,A=a.backgroundImageSrc),e="number"==typeof a.translateX?a.translateX:g.translate.x,c="number"==typeof a.translateY?a.translateY:g.translate.y;if(a.backgroundImage){var L=this.$imageSrc.indexOf(A);if(-1==L){var p=new Image,F=this;p.onload=function(){F.$imageData.push(this);F.$imageSrc.push(this.src);F.$imageDataMatch[w[k]]=
F.$imageData.length-1;F.createElement(F.$element)};p.src=A;a.$backgroundImage={width:NaN,height:NaN}}else{var n=this.$imageData[L],x=f<n.width?f:n.width,y=q<n.height?q:n.height;a.$backgroundImage={width:n.width,height:n.height}}}if(!1===a.show||"false"==a.show){a.show=!1;this.$element[w[k]]=a;this.$context.restore();continue}if(!0===a.onlyBaseElement||"true"==a.onlyBaseElement){a.onlyBaseElement=!0;this.$element[w[k]]=a;this.$context.restore();continue}this.$context.translate(e,c);a.rotate&&(C=h,
K=l,this.$context.translate(h+a.rotateOriginX,l+a.rotateOriginY),h=-a.rotateOriginX,l=-a.rotateOriginY,this.$context.rotate(a.rotate*Math.PI/180));0<a.borderWidth&&this.$context.strokeRect(h-a.borderWidth/2,l-a.borderWidth/2,f+a.borderWidth,q+a.borderWidth);this.$context.fillRect(h,l,f,q);if(-1!==L)if("no-repeat"==z)z=A=0,e=x,c=y,p=h+v,B=l+r,0>v?(A=-v,e=x,p=h):v+n.width>f&&(A=0,e=f-v),0>r?(z=-r,c=y,B=l):r+n.height>q&&(z=0,c=q-r),this.$context.drawImage(n,A,z,e,c,p,B,e,c);else if("repeat"==z){var v=
Math.ceil(f/n.width),r=Math.ceil(q/n.height),G=v*r,D=f%n.width,E=q%n.height;for(f=1;f<=G;f++)f==G?this.$context.drawImage(n,0,0,D,E,h+(v-1)*x,l+(r-1)*y,D,E):0==f%v?this.$context.drawImage(n,0,0,D,y,h+(v-1)*x,l+parseInt((f-1)/v)*y,D,y):f>(r-1)*v?this.$context.drawImage(n,0,0,x,E,h+parseInt((f-1)%v)*x,l+(r-1)*y,x,E):this.$context.drawImage(n,0,0,x,y,h+(f%v-1)*x,l+parseInt((f-1)/v)*y,x,y)}else{var I,J;switch(z){case "repeat-x":G=parseInt(f/n.width);D=f%n.width;E=q<n.height?q:n.height;I=n.width;J=0;x=
f<n.width?f:n.width;break;case "repeat-y":G=parseInt(q/n.height),E=q%n.height,D=f<n.width?f:n.width,I=0,J=n.height,y=q<n.height?q:n.height}for(f=0;f<=G;f++)f==G?this.$context.drawImage(n,0,0,D,E,h+f*I,l+f*J,D,E):this.$context.drawImage(n,0,0,x,y,h+f*I,l+f*J,x,y)}h=C?C:h;l=K?K:l;a.$x=h;a.$y=l;break;case "path":if(a.$temp||!$element){if(!$element&&"string"==typeof a.border||"string"==typeof a.border&&$element&&$element.border!=a.border)p=a.border.split(" "),e=m(p[0],0,g.borderWidth),this.$context.lineWidth=
...
a.line[f][1]);if(!0===a.figure||"true"==a.figure)a.figure=!0,this.$context.closePath();a.background&&!0===a.figure&&(this.$context.fillStyle=a.background,this.$context.fill());this.$context.stroke()}break;case "circle":if(a.$temp||!$element){h=m(a.x,$element&&$element.x||0,g.circle.x);l=m(a.y,$element&&$element.y||0,g.circle.y);isR1=!$element&&a.r1||$element&&$element.r1!=a.r1;isR2=!$element&&a.r2||$element&&$element.r2!=a.r2;if(!$element&&"string"==typeof a.r||$element&&$element.r!=a.r)C="string"==
...
this.$context.strokeStyle=c;e||(e=m(a.borderWidth,$element&&$element.borderWidth||0,g.borderWidth),this.$context.lineWidth=e);c||(c=a.borderColor||g.borderColor,this.$context.strokeStyle=c);a.borderWidth=e;a.borderColor=c;a.border=e+" solid "+c;a.start||(a.start=g.circle.start);a.end||(a.end=g.circle.end);a.clock||(a.clock=g.circle.clock);p="string"==typeof a.origin?a.origin.split(" "):g.origin;h-=u(2*a.r1,p[0],g.origin[0]);l-=u(2*a.r2,p[1],g.origin[1]);this.$context.beginPath();a.r2&&a.r1!=a.r2?
this.$context.ellipse(h,l,a.r1,a.r2,0,a.start,a.end,!1):this.$context.arc(h,l,a.r1,a.start,a.end,a.clock);a.background&&(this.$context.fillStyle=a.background,this.$context.fill());0<a.borderWidth&&this.$context.stroke();"object"!=typeof event.c&&(event.c={});a.r1>a.r2?(event.c.x=Math.sqrt((a.r1-a.r2)*(a.r1+a.r2))+h,event.c.y=l,event.c.mirrorx=-event.c.x+2*h,event.c.mirrory=l,event.a=a.r1,event.mirror=!0):a.r1==a.r2?(event.c.x=h,event.c.y=l,event.c.mirrorx=h,event.c.mirrory=l,event.a=a.r1,event.mirror=
!0):(event.c.y=Math.sqrt((a.r2-a.r1)*(a.r1+a.r2))+l,event.c.x=h,event.c.mirrorx=h,event.c.mirrory=-event.c.y+2*l,event.a=a.r2,event.mirror=!1);a.$x=h;a.$y=l;delete a.$temp}else this.$context.beginPath(),a.r2&&a.r1!=a.r2?this.$context.ellipse(a.$x,a.$y,a.r1,a.r2,0,a.start,a.end,!1):this.$context.arc(a.$x,a.$y,a.r1,a.start,a.end,a.clock),a.background&&(this.$context.fillStyle=a.background,this.$context.fill()),0<a.borderWidth&&this.$context.stroke();break;case "text":h="string"==typeof a.content||"number"==
typeof a.content?a.content:g.content,this.$context.font=(a.fontSize||g.fontSize)+"px "+(a.fontFamily||g.fontFamily),a.x=m(a.x,$element&&$element.x,g.x),a.y=m(a.y,$element&&$element.y,g.y),this.$context.fillText(h,a.x,a.y)}this.$element[w[k]]=a;this.$context.restore()}};Canvas.prototype.element=function(b){if(!this.$canvas)return console.error("CvSS ERROR : not found element"),0;if(b==this)return this.$windowEvent;"string"!=typeof b&&"number"!=typeof b||this.$cvss_target.push(String(b));return this};
Canvas.prototype.cvss=function(b,d){var e=this.$cvss_target[this.$cvss_target.length-1];if(!this.$element[e])return console.error("CvSS ERROR : not found element"),0;this.$cvss_target.pop();var c={};if(!d&&""!=d||"string"!=typeof b){if("[object Array]"===Object.prototype.toString.call(b)){for(var k={},c=0;c<b.length;c++)k[b[c]]=this.$element[e][b[c]];return k}if("object"==typeof b)c[e]=Canvas.prototype.setBaseObj(this.$element[e],b,!0),this.createElement(c);else if(this.$element[e]&&this.$element[e][b])return"object"==
typeof this.$element[e][b]?Canvas.prototype.CopyObj(this.$element[e][b]):this.$element[e][b]}else c[e]=Canvas.prototype.CopyObj(this.$element[e]),c[e][b]=d,this.createElement(c)};Canvas.prototype.getInfo=function(){var b=this.$cvss_target[this.$cvss_target.length-1];if(!this.$element[b])return console.error("CvSS ERROR : not found element"),0;this.$cvss_target.pop();return Canvas.prototype.CopyObj(this.$element[b])};Canvas.prototype.create=function(b){var d=[];d[this.$cvss_target]=b;this.$cvss_target.pop();
this.createElement(d);return 1};Canvas.prototype.remove=function(){var b=this.$cvss_target[this.$cvss_target.length-1];if(!this.$element[b])return console.error("CvSS ERROR : not found element"),0;delete this.$element[b];delete this.$eventFunc[b];this.$cvss_target.pop();this.createElement(this.$element)};Canvas.prototype.submitEvent=function(b,d){var e=this.$cvss_target[this.$cvss_target.length-1];this.$cvss_target.pop();if("string"!=typeof b||-1==Canvas.prototype.$Element_Event.indexOf(b)||"function"!=
typeof d)return 0;"object"!=typeof this.$eventFunc[e]&&(this.$eventFunc[e]={});this.$eventFunc[e][b]=d};Canvas.prototype.mousedown=function(b){this.submitEvent("mousedown",b)};Canvas.prototype.mouseup=function(b){this.submitEvent("mouseup",b)};Canvas.prototype.dblclick=function(b){this.submitEvent("dblclick",b)};Canvas.prototype.mousein=function(b){this.submitEvent("mousein",b)};Canvas.prototype.mouseout=function(b){this.submitEvent("mouseout",b)};Canvas.prototype.dragstart=function(b){this.submitEvent("dragstart",
b)};Canvas.prototype.drag=function(b){this.submitEvent("drag",b)};Canvas.prototype.drop=function(b){this.submitEvent("drop",b)};Canvas.prototype.hover=function(b,d){var e=this.$cvss_target[this.$cvss_target.length-1];"function"==typeof b&&this.submitEvent("mousein",b);this.$cvss_target.push(e);"function"==typeof d&&this.submitEvent("mouseout",d)};Canvas.prototype.click=function(b){var d=this.$cvss_target[this.$cvss_target.length-1];this.$cvss_target.pop();"object"!=typeof this.$eventFunc[d]&&(this.$eventFunc[d]=
{});this.$eventFunc[d].click=b};Canvas.prototype.hide=function(b){b=this.$cvss_target[this.$cvss_target.length-1];this.$cvss_target.pop();this.$element[b]&&(this.$element[b].show=!1,this.createElement(this.$element));return 0};Canvas.prototype.show=function(b){b=this.$cvss_target[this.$cvss_target.length-1];this.$cvss_target.pop();this.$element[b]&&(this.$element[b].show=!0,this.createElement(this.$element));return 0};Canvas.prototype.bind=function(b,d){var e=this.$cvss_target[this.$cvss_target.length-
1];if("string"!=typeof b)return console.warn("Cvss Warning : bind's events is string"),0;b=b.split(" ");var c;for(c=0;c<b.length;c++)-1!=Canvas.prototype.$Element_Event.indexOf(b[c])&&(this.submitEvent(b[c],d),this.$cvss_target.push(e));this.$cvss_target.pop()};Canvas.prototype.unbind=function(b){var d=this.$cvss_target[this.$cvss_target.length-1];if("string"!=typeof b)return console.warn("Cvss Warning : bind's events is string"),0;b=b.split(" ");var e;for(e=0;e<b.length;e++)if(-1!=Canvas.prototype.$Element_Event.indexOf(b[e])&&
this.$eventFunc[d])return delete this.$eventFunc[d][b[e]],1;this.$cvss_target.pop();return 0};Canvas.prototype.$initElement={translate:{x:0,y:0},scale:{x:0,y:0},zindex:0,type:"block",width:50,height:50,x:0,y:0,background:"rgba(0,0,0,0)",opacity:1,origin:["0","0"],circle:{x:0,y:0,r:10,start:0,end:2*Math.PI,clock:!0},backgroundImage:{src:void 0,pattern:"no-repeat"},border:[1],cursor:"default",fontSize:"12px",fontFamily:"Arial",borderColor:"black",borderWidth:0,content:"",figure:!0,rotate:0,rotateOrigin:{x:0,
y:0}};Canvas.prototype.$Element_Type=["block","path","circle","text"];Canvas.prototype.$Element_Event="mouseup mousedown click mousein mouseout dblclick dragstart drag drop".split(" ");Canvas.prototype.$lineJoin=["miter","round","bevel"];Canvas.prototype.$backgroundRepeatType=["no-repeat","repeat","repeat-y","repeat-x"];Canvas.prototype.CopyObj=function(b){return b?JSON.parse(JSON.stringify(b)):{}}})(window);
